...
public class KhachHangView extends JPanel {
    ...
    private void initComponents() {
        ...
        customerTable.getTableHeader().setBackground(DARK_BLUE_ACCENT);
        ...
        customerTable.setGridColor(BORDER_COLOR); // Consistent grid lines
        customerTable.setFont(new Font("Arial", Font.PLAIN, 12)); // Consistent font for table data
        ...
        txtMaKhachHang.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border

        txtHoTen = new JTextField(20);
        txtHoTen.putClientProperty("JTextField.placeholderText", "Nhập họ tên");
        txtHoTen.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border

        txtNgaySinh = new JTextField(10);
        txtNgaySinh.putClientProperty("JTextField.placeholderText", "YYYY-MM-DD");
        txtNgaySinh.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border
        ...
        cbxGioiTinh.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border

        txtSdt = new JTextField(15);
        txtSdt.putClientProperty("JTextField.placeholderText", "Nhập số điện thoại");
        txtSdt.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border

        txtMaNguoiDung = new JTextField(10);
        txtMaNguoiDung.setEditable(false); // Mã người dùng tự động, không cho sửa
        txtMaNguoiDung.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border
        ...
        txtUsername.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border

        txtPassword = new JPasswordField(15);
        txtPassword.putClientProperty("JTextField.placeholderText", "Mật khẩu mới");
        txtPassword.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border
        ...
        txtEmail.setBorder(new RoundedCornerBorder(10, BORDER_COLOR, 2)); // Thicker border
    ...
    private JButton createStyledButton(String text) {
        ...
        button.setBackground(DARK_BLUE_ACCENT); // Dark blue
     ...
     * Đã điều chỉnh để chia giao diện thành 2 bên chính (bảng và chi tiết/điều khiển).
     */
    private void layoutComponents() {
        ...
        // Right side: Details Panel (contains input form, buttons, message, and search)
        JPanel detailsAndControlPanel = new JPanel(new BorderLayout(10, 10));
        detailsAndControlPanel.setBackground(BACKGROUND_COLOR); // Background for the details panel
        detailsAndControlPanel.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 0)); // Padding between split pane divider and content

        // North of Right Panel: Search
        ...
        searchPanel.setBorder(BorderFactory.createEmptyBorder(5,5,5,5)); // Inner padding
        searchPanel.add(new JLabel("Tìm kiếm (Tên/SĐT):"));
        searchPanel.add(txtSearch);
        searchPanel.add(btnSearch);
        detailsAndControlPanel.add(searchPanel, BorderLayout.NORTH);

        // Center of Right Panel: Input Form
        ...
        inputPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(BORDER_COLOR, 2, true), // Thicker border, rounded
        ...
        detailsAndControlPanel.add(inputPanel, BorderLayout.CENTER); // Input panel at the top of detailsPanel

        // South of Right Panel: Buttons and Message
        ...
        buttonAndMessagePanel.setBorder(new EmptyBorder(5, 5, 5, 5)); // Padding for this sub-panel
        ...
        detailsAndControlPanel.add(buttonAndMessagePanel, BorderLayout.SOUTH);

        splitPane.setRightComponent(detailsAndControlPanel);
